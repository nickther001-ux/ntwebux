...
export function CommandPalette({ open, onClose }: Props) {
  ...
  const items: Item[] = useMemo(() => {
    const en: Item[] = [
      ...
      { id: 'business',   label: 'Business Suite', desc: 'AI revenue engines & enterprise platforms', group: 'Pages',    icon: Cpu,       href: '#business-suite',   isAnchor: true },
    ...
    const fr: Item[] = [
      ...
      { id: 'business',   label: 'Business Suite',          desc: 'Moteurs IA & plateformes entreprise',        group: 'Pages',    icon: Cpu,       href: '#business-suite', isAnchor: true },
