        ...
        {open && (
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <a
                href={`tel:+${PHONE_RAW}`}
                style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', background: 'rgba(124,58,237,0.1)', border: '1px solid rgba(124,58,237,0.2)', borderRadius: '10px', textDecoration: 'none', color: '#c4b5fd', fontSize: '13px', fontWeight: 500 }}
              >
