...
const RAW_PROJECTS = [
  {
    ...
    tags: {
      en: ["HR Consultant", "Personal Brand"],
      fr: ["Conseil RH", "Image personnelle"],
    },
  ...
  },
  {
    ...
    tags: {
      en: ["LED Lighting", "eCommerce"],
      fr: ["Éclairage LED", "Commerce en ligne"],
    },
    buildTime: { en: "5 days", fr: "5 jours" },
    wide: false,
  ...
  },
  {
    ...
    tags: {
      en: ["Booking System", "Branding"],
      fr: ["Réservation", "Image de marque"],
    },
    buildTime: { en: "4 days", fr: "4 jours" },
    wide: false,
  },
  {
    img: `${BASE}/portfolio/proj-new-haiti.png`,
    category: { en: "Strategic Development", fr: "Développement Stratégique" },
    title: { en: "New Haiti", fr: "New Haiti" },
    tags: {
  ...
  },
  {
    ...
    category: { en: "Construction", fr: "Construction" },
    title: { en: "RenoCasa Group", fr: "RenoCasa Group" },
    tags: { en: ["Corporate", "Web Design"], fr: ["Corporate", "Web Design"] },
    buildTime: { en: "6 days", fr: "6 jours" },
    wide: false,
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? "0 0 0 1px rgba(59,130,246,0.1), 0 16px 48px rgba(0,0,0,0.5)"
          : "none",
      }}
    >
      {/* Image */}
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          aspectRatio:
            (project as any).ratio || (project.wide ? "21/9" : "16/9"),
          background: "#0a1628",
        }}
      >
        <img
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg, rgba(6,13,26,0.85) 0%, rgba(37,99,235,0.3) 100%)",
            opacity: hovered ? 1 : 0,
...
export function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      style={{ width: "100%", padding: "120px 24px", position: "relative" }}
    >
      {/* Ambient orb */}
      <div
        style={{
