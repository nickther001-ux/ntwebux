...
export function NTBusinessSuite() {
  ...
  const s = {
    ...
    trustBadge: { en: 'Built in Montreal', fr: 'Fondé à Montréal' },
    trustH: { en: 'Built for Canadian service businesses.', fr: 'Conçu pour les entreprises de services canadiennes.' },
    trustS: { en: "We're a Montreal-based team that understands the Canadian market — bilingual customers, Law 25 compliance, and the unique challenges of running a service business in Quebec and across Canada.", fr: "Nous sommes une équipe basée à Montréal qui comprend le marché canadien — clients bilingues, conformité à la Loi 25, et les défis uniques de gérer une entreprise de services au Québec et partout au Canada." },
