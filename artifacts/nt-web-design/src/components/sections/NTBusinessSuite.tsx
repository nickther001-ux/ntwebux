...
const FEATURES_EN = [
  {
    ...
    color: "34,211,238",
    title: "AI Text-Back",
    sub: "Every missed call becomes a conversation",
    desc: "Our AI detects missed calls in seconds and fires a conversational SMS — qualifying the lead before they call your competitor.",
    roi: "+22% avg. closed deals recovered",
    viz: "console",
  },
  {
    icon: CalendarCheck,
    color: "99,102,241",
    title: "Auto-Booking",
    sub: "Fill your calendar without lifting a finger",
    desc: "Syncs directly with Google and Outlook. Qualified leads book their own estimate in real-time — no back-and-forth, no dropped leads.",
    roi: "Saves 14 h/week on admin",
    viz: "analytics",
  },
  {
    icon: Star,
    color: "52,211,153",
    title: "Review Engine",
    sub: "Dominate Google in 90 days",
    desc: "Automated SMS review requests fire the moment a job is complete. Most clients see a 3x increase in Google reviews within 60 days.",
    roi: "+61% avg. organic traffic in 90 days",
    viz: "stars",
  },
  {
    icon: Users,
    color: "59,130,246",
    title: "CRM & Pipeline",
    sub: "Know exactly where every lead stands",
    desc: "Visual pipeline management that shows every lead at every stage. Never lose track of a follow-up — the system prompts you automatically.",
    roi: "Zero leads fall through the cracks",
    viz: "pipeline",
  },
  {
    icon: MessageSquare,
    ...
    sub: "Have real conversations, at scale",
    desc: "Full two-way communication hub. Reply to leads via SMS or email from one dashboard — the AI drafts responses so you just approve and send.",
    roi: "4x faster lead response time",
    viz: "chat",
  },
  {
    icon: TrendingUp,
    ...
    sub: "Know what is working, every single day",
    desc: "Daily performance reports delivered to your inbox. Track leads by source, conversion rates, revenue attributed, and team response times.",
    roi: "Full pipeline visibility, daily",
    viz: "analytics",
  },
  {
    icon: PhoneCall,
    ...
    sub: "Never miss an inbound call again",
    desc: "Our AI voice agent answers every call 24/7 — qualifying leads, booking estimates, and answering FAQs in natural conversation. Full call transcript delivered to your dashboard.",
    roi: "100% of inbound calls answered",
    viz: "voice",
  },
];
...
const FEATURES_FR = [
  {
    icon: MessageSquare,
    color: "34,211,238",
    title: "Réponse SMS IA",
    sub: "Chaque appel manqué devient une conversation",
    desc: "Notre IA détecte les appels manqués en quelques secondes et déclenche un SMS conversationnel — qualifiant le lead avant de rappeler votre concurrent.",
    roi: "+22 % de ventes récupérées en moyenne",
    viz: "console",
  },
  {
    icon: CalendarCheck,
    ...
    sub: "Remplissez votre agenda sans lever le doigt",
    desc: "Synchronise directement Google et Outlook. Les leads qualifiés réservent leur estimation en temps réel — sans allers-retours, sans prospects perdus.",
    roi: "Économise 14 h/semaine en admin",
    viz: "analytics",
  },
  {
    icon: Star,
    color: "52,211,153",
    title: "Moteur d'Avis",
    sub: "Dominez Google en 90 jours",
    desc: "Les demandes d'avis SMS se déclenchent dès qu'un contrat est terminé. La plupart des clients voient leurs avis Google tripler en 60 jours.",
    roi: "+61 % de trafic organique en 90 jours",
    viz: "stars",
  },
  {
    icon: Users,
    color: "59,130,246",
    title: "CRM & Pipeline",
    sub: "Sachez exactement où en est chaque lead",
    desc: "Pipeline visuel qui montre chaque lead à chaque étape. Plus jamais un suivi oublié — le système vous le rappelle automatiquement.",
    roi: "Zéro lead perdu dans les mailles",
    viz: "pipeline",
  },
  {
    icon: MessageSquare,
    color: "167,139,250",
    title: "SMS & Email Bidirectionnel",
    sub: "De vraies conversations, à grande échelle",
    desc: "Hub de communication bilingue complet. Répondez aux leads par SMS ou email depuis un seul tableau de bord — l'IA rédige les réponses.",
    roi: "Temps de réponse 4x plus rapide",
    viz: "chat",
  },
  {
    icon: TrendingUp,
    ...
    sub: "Sachez ce qui fonctionne chaque jour",
    desc: "Rapports de performance quotidiens livrés dans votre boîte mail. Suivez les leads par source, les taux de conversion et les revenus attribués.",
    roi: "Visibilité complète du pipeline, chaque jour",
    viz: "analytics",
  },
  {
    icon: PhoneCall,
    ...
    sub: "Ne manquez plus jamais un appel entrant",
    desc: "Notre agent vocal IA répond à chaque appel 24h/24 — qualifie les leads, réserve des estimations et répond aux FAQ en conversation naturelle.",
    roi: "100 % des appels entrants répondus",
    viz: "voice",
  },
];
