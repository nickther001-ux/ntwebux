        ...
        {services.map((s, i) => (
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '10px', background: 'rgba(59,130,246,0.12)', border: '1px solid rgba(59,130,246,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#93c5fd' }}>
                <s.icon size={20} />
              </div>
            ...
            <div style={{ fontSize: '12px', color: '#93c5fd', fontWeight: 600, marginTop: 'auto' }}>{learnMore}</div>
          </motion.button>
        ))}
      </div>
