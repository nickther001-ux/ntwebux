  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { quote: "The bilingual site they built helped us reach both markets properly. Organic traffic climbed around 61% over three months — better than I expected.", name: "Marc-André Ouellet", role: "Owner, Reno Casa Group", metric: "+61% traffic", metricLabel: "organic, 3 months", img: "proj-construction2.webp", industry: "🏗️ Construction", stars: 4.7 }
      ]
    },
    contact: {
