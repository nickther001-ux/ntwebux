...
const translations: Translations = {
  en: {
    ...
    chat: {
      ...
      welcome: "Welcome to NT Digital Group. I am Jean 2.4. Are you here to Scale a Foundation or Automate your Revenue?",
      ...
      rules: {
        ...
        hello:    "I am Jean 2.4, the NT Digital assistant. I can help you navigate our services or book a technical consultation with our team.",
        ...
        global:   "We operate a borderless agency model with hubs in Montreal and Abidjan. This allows us to offer 24/7 technical architecture and bilingual (FR/EN) solutions that bridge the gap between markets.",
        ...
        fallback: "I'm still learning the intricacies of your business. Would you like to book a direct technical session with Jean to discuss your specific architecture?",
      },
    },
    footer: {
  ...
  fr: {
    ...
    chat: {
      ...
      welcome: "Bienvenue chez NT Digital Group. Je suis Jean 2.4. Êtes-vous ici pour Construire des Fondations ou Automatiser vos Revenus ?",
      ...
      rules: {
        ...
        hello:    "Je suis Jean 2.4, l'assistant NT Digital. Je peux vous aider à naviguer dans nos services ou à réserver une consultation technique.",
        ...
        global:   "Nous opérons un modèle d'agence sans frontières avec des bureaux à Montréal et Abidjan. Cela nous permet d'offrir une architecture technique 24h/24 et des solutions bilingues (FR/EN) qui créent des ponts entre les marchés.",
        ...
        fallback: "J'apprends encore les subtilités de votre activité. Souhaitez-vous réserver une session technique directe avec Jean pour discuter de votre architecture spécifique ?",
      },
    },
    footer: {
