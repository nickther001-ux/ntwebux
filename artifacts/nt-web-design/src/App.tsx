    ...
    <QueryClientProvider client={queryClient}>
      ...
      <div className="orb-layer" style={{ position: "fixed", inset: 0, zIndex: 0, overflow: "hidden", pointerEvents: "none", isolation: "isolate", transform: "translateZ(0)" }} aria-hidden>
        ...
        <div className="orb orb-hero" style={{
          ...
          height: "820px",
          borderRadius: "50%",
          background: "radial-gradient(ellipse at center, rgba(59,130,246,0.75) 0%, rgba(37,99,235,0.42) 32%, transparent 62%)",
          filter: "blur(90px)",
        ...
        <div className="orb orb-right" style={{
          ...
          height: "700px",
          borderRadius: "50%",
          background: "radial-gradient(ellipse at center, rgba(29,78,216,0.6) 0%, rgba(17,51,160,0.28) 40%, transparent 65%)",
          filter: "blur(80px)",
        ...
        <div className="orb orb-left" style={{
          ...
          height: "500px",
          borderRadius: "50%",
          background: "radial-gradient(ellipse at center, rgba(59,130,246,0.38) 0%, transparent 65%)",
          filter: "blur(70px)",
          willChange: "transform",
